...
-- --------------------------------------------------
-- Date Created: 04/14/2019 00:19:25
-- Generated from EDMX file: C:\Users\Lane\source\repos\try2\Project4\Project4\dbModel.edmx
-- --------------------------------------------------

SET QUOTED_IDENTIFIER OFF;
GO
USE [aspnet-Project4-20190413095827];
GO
...
CREATE TABLE [dbo].[Cards] (
    [Id] int IDENTITY(1,1) NOT NULL,
    [DeckId] int  NOT NULL,
    [CardFront] nvarchar(max)  NOT NULL,
    [CardBack] nvarchar(max)  NOT NULL
);
GO
...
-- Creating foreign key on [AspNetUserId] in table 'Decks'
ALTER TABLE [dbo].[Decks]
ADD CONSTRAINT [FK_AspNetUserDeck]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_AspNetUserDeck'
CREATE INDEX [IX_FK_AspNetUserDeck]
ON [dbo].[Decks]
    ([AspNetUserId]);
GO
